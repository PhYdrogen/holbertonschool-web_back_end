...
describe('when type is SUM', () => {
    it('it round the first argument', () => {
        chai.expect(calculateNumber('SUM', 1.0, 0), 1);
        chai.expect(calculateNumber('SUM', 1.3, 0), 1);
        chai.expect(calculateNumber('SUM', 1.7, 0), 2);
    });
    
    it('it round the second argument', () => {
        chai.expect(calculateNumber('SUM', 0, 1.0), 1);
        chai.expect(calculateNumber('SUM', 0, 1.3), 1);
        chai.expect(calculateNumber('SUM', 0, 1.7), 2);
    });
    
    it('it should return the right number', () => {
        chai.expect(calculateNumber('SUM', 1.3, 0), 1);
        chai.expect(calculateNumber('SUM', 0, 1.2), 1);
        chai.expect(calculateNumber('SUM', 1.3, 1.3), 2);
        chai.expect(calculateNumber('SUM', 1.7, 1.2), 3);
        chai.expect(calculateNumber('SUM', 1.3, 1.8), 3);
        chai.expect(calculateNumber('SUM', 1.6, 1.8), 4);
    });
  });

  describe('when type is SUBTRACT', () => {
    it('it round the first argument', () => {
        chai.expect(calculateNumber('SUBTRACT', 1.0, 0), 1);
        chai.expect(calculateNumber('SUBTRACT', 1.3, 0), 1);
        chai.expect(calculateNumber('SUBTRACT', 1.7, 0), 2);
    });
    
    it('it round the second argument', () => {
        chai.expect(calculateNumber('SUBTRACT', 0, 1.0), -1);
        chai.expect(calculateNumber('SUBTRACT', 0, 1.3), -1);
        chai.expect(calculateNumber('SUBTRACT', 0, 1.7), -2);
    });
    
    it('it should return the right number', () => {
        chai.expect(calculateNumber('SUBTRACT', 1.3, 0), 1);
        chai.expect(calculateNumber('SUBTRACT', 0, 1.2), -1);
        chai.expect(calculateNumber('SUBTRACT', 1.3, 1.3), 0);
        chai.expect(calculateNumber('SUBTRACT', 1.7, 1.2), 1);
        chai.expect(calculateNumber('SUBTRACT', 1.3, 1.8), -1);
        chai.expect(calculateNumber('SUBTRACT', 1.6, 1.8), 0);
    });
  });
